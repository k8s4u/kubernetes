...
func RegisterDefaults(scheme *runtime.Scheme) error {
	scheme.AddTypeDefaultingFunc(&v2alpha1.DaemonSet{}, func(obj interface{}) { SetObjectDefaults_DaemonSet(obj.(*v2alpha1.DaemonSet)) })
	scheme.AddTypeDefaultingFunc(&v2alpha1.DaemonSetList{}, func(obj interface{}) { SetObjectDefaults_DaemonSetList(obj.(*v2alpha1.DaemonSetList)) })
	scheme.AddTypeDefaultingFunc(&v2alpha1.Deployment{}, func(obj interface{}) { SetObjectDefaults_Deployment(obj.(*v2alpha1.Deployment)) })
	scheme.AddTypeDefaultingFunc(&v2alpha1.DeploymentList{}, func(obj interface{}) { SetObjectDefaults_DeploymentList(obj.(*v2alpha1.DeploymentList)) })
	scheme.AddTypeDefaultingFunc(&v2alpha1.ReplicaSet{}, func(obj interface{}) { SetObjectDefaults_ReplicaSet(obj.(*v2alpha1.ReplicaSet)) })
	scheme.AddTypeDefaultingFunc(&v2alpha1.ReplicaSetList{}, func(obj interface{}) { SetObjectDefaults_ReplicaSetList(obj.(*v2alpha1.ReplicaSetList)) })
	scheme.AddTypeDefaultingFunc(&v2alpha1.StatefulSet{}, func(obj interface{}) { SetObjectDefaults_StatefulSet(obj.(*v2alpha1.StatefulSet)) })
	scheme.AddTypeDefaultingFunc(&v2alpha1.StatefulSetList{}, func(obj interface{}) { SetObjectDefaults_StatefulSetList(obj.(*v2alpha1.StatefulSetList)) })
	return nil
}

func SetObjectDefaults_DaemonSet(in *v2alpha1.DaemonSet) {
...
func SetObjectDefaults_DaemonSetList(in *v2alpha1.DaemonSetList) {
...
func SetObjectDefaults_Deployment(in *v2alpha1.Deployment) {
...
func SetObjectDefaults_DeploymentList(in *v2alpha1.DeploymentList) {
	for i := range in.Items {
		a := &in.Items[i]
...
func SetObjectDefaults_ReplicaSet(in *v2alpha1.ReplicaSet) {
...
func SetObjectDefaults_ReplicaSetList(in *v2alpha1.ReplicaSetList) {
	for i := range in.Items {
		a := &in.Items[i]
...
func SetObjectDefaults_StatefulSet(in *v2alpha1.StatefulSet) {
...
func SetObjectDefaults_StatefulSetList(in *v2alpha1.StatefulSetList) {
	for i := range in.Items {
		a := &in.Items[i]
