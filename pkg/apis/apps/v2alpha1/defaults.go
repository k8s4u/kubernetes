...
func SetDefaults_Deployment(obj *appsv2alpha1.Deployment) {
	...
	if strategy.Type == "" {
		strategy.Type = appsv2alpha1.RollingUpdateDeploymentStrategyType
	}
	if strategy.Type == appsv2alpha1.RollingUpdateDeploymentStrategyType {
...
func SetDefaults_DaemonSet(obj *appsv2alpha1.DaemonSet) {
	updateStrategy := &obj.Spec.UpdateStrategy
	if updateStrategy.Type == "" {
		updateStrategy.Type = appsv2alpha1.RollingUpdateDaemonSetStrategyType
	}
	if updateStrategy.Type == appsv2alpha1.RollingUpdateDaemonSetStrategyType {
...
func SetDefaults_StatefulSet(obj *appsv2alpha1.StatefulSet) {
	if len(obj.Spec.PodManagementPolicy) == 0 {
		obj.Spec.PodManagementPolicy = appsv2alpha1.OrderedReadyPodManagement
	}

	if obj.Spec.UpdateStrategy.Type == "" {
		obj.Spec.UpdateStrategy.Type = appsv2alpha1.RollingUpdateStatefulSetStrategyType

		if obj.Spec.UpdateStrategy.RollingUpdate == nil {
			// UpdateStrategy.RollingUpdate will take default values below.
			obj.Spec.UpdateStrategy.RollingUpdate = &appsv2alpha1.RollingUpdateStatefulSetStrategy{}
		}
	}

	if obj.Spec.UpdateStrategy.Type == appsv2alpha1.RollingUpdateStatefulSetStrategyType &&
	...
	if utilfeature.DefaultFeatureGate.Enabled(features.StatefulSetAutoDeletePVC) {
		if obj.Spec.PersistentVolumeClaimRetentionPolicy == nil {
			obj.Spec.PersistentVolumeClaimRetentionPolicy = &appsv2alpha1.StatefulSetPersistentVolumeClaimRetentionPolicy{}
		}
		if len(obj.Spec.PersistentVolumeClaimRetentionPolicy.WhenDeleted) == 0 {
			obj.Spec.PersistentVolumeClaimRetentionPolicy.WhenDeleted = appsv2alpha1.RetainPersistentVolumeClaimRetentionPolicyType
		}
		if len(obj.Spec.PersistentVolumeClaimRetentionPolicy.WhenScaled) == 0 {
			obj.Spec.PersistentVolumeClaimRetentionPolicy.WhenScaled = appsv2alpha1.RetainPersistentVolumeClaimRetentionPolicyType
		}
	}
...
func SetDefaults_ReplicaSet(obj *appsv2alpha1.ReplicaSet) {
	if obj.Spec.Replicas == nil {
		obj.Spec.Replicas = new(int32)
		*obj.Spec.Replicas = 1
	}
