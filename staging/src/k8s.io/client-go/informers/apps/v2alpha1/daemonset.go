...
type DaemonSetInformer interface {
	...
	Lister() v2alpha1.DaemonSetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV2alpha1().DaemonSets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV2alpha1().DaemonSets(namespace).Watch(context.TODO(), options)
			},
		},
		&appsv2alpha1.DaemonSet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *daemonSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv2alpha1.DaemonSet{}, f.defaultInformer)
}

func (f *daemonSetInformer) Lister() v2alpha1.DaemonSetLister {
	return v2alpha1.NewDaemonSetLister(f.Informer().GetIndexer())
}
