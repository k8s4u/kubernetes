...
import (
	...
	v2alpha1 "k8s.io/client-go/listers/apps/v2alpha1"
...
type ControllerRevisionInformer interface {
	...
	Lister() v2alpha1.ControllerRevisionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV2alpha1().ControllerRevisions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV2alpha1().ControllerRevisions(namespace).Watch(context.TODO(), options)
			},
		},
		&appsv2alpha1.ControllerRevision{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *controllerRevisionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv2alpha1.ControllerRevision{}, f.defaultInformer)
}

func (f *controllerRevisionInformer) Lister() v2alpha1.ControllerRevisionLister {
	return v2alpha1.NewControllerRevisionLister(f.Informer().GetIndexer())
}
