...
type ReplicaSetInformer interface {
	...
	Lister() v2alpha1.ReplicaSetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV2alpha1().ReplicaSets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV2alpha1().ReplicaSets(namespace).Watch(context.TODO(), options)
			},
		},
		&appsv2alpha1.ReplicaSet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *replicaSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv2alpha1.ReplicaSet{}, f.defaultInformer)
}

func (f *replicaSetInformer) Lister() v2alpha1.ReplicaSetLister {
	return v2alpha1.NewReplicaSetLister(f.Informer().GetIndexer())
}
