...
type StatefulSetInformer interface {
	...
	Lister() v2alpha1.StatefulSetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV2alpha1().StatefulSets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV2alpha1().StatefulSets(namespace).Watch(context.TODO(), options)
			},
		},
		&appsv2alpha1.StatefulSet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *statefulSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv2alpha1.StatefulSet{}, f.defaultInformer)
}

func (f *statefulSetInformer) Lister() v2alpha1.StatefulSetLister {
	return v2alpha1.NewStatefulSetLister(f.Informer().GetIndexer())
}
