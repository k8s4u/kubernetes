...
type StatefulSetUpdateStrategyApplyConfiguration struct {
	Type          *v2alpha1.StatefulSetUpdateStrategyType             `json:"type,omitempty"`
...
func (b *StatefulSetUpdateStrategyApplyConfiguration) WithType(value v2alpha1.StatefulSetUpdateStrategyType) *StatefulSetUpdateStrategyApplyConfiguration {
	b.Type = &value
	return b
}
