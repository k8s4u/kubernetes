...
func ControllerRevision(name, namespace string) *ControllerRevisionApplyConfiguration {
	...
	b.WithAPIVersion("apps/v2alpha1")
	return b
}
...
// Experimental!
func ExtractControllerRevision(controllerRevision *v2alpha1.ControllerRevision, fieldManager string) (*ControllerRevisionApplyConfiguration, error) {
...
// Experimental!
func ExtractControllerRevisionStatus(controllerRevision *v2alpha1.ControllerRevision, fieldManager string) (*ControllerRevisionApplyConfiguration, error) {
	return extractControllerRevision(controllerRevision, fieldManager, "status")
}

func extractControllerRevision(controllerRevision *v2alpha1.ControllerRevision, fieldManager string, subresource string) (*ControllerRevisionApplyConfiguration, error) {
	b := &ControllerRevisionApplyConfiguration{}
	err := managedfields.ExtractInto(controllerRevision, internal.Parser().Type("io.k8s.api.apps.v2alpha1.ControllerRevision"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
