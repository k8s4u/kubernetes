...
// Experimental!
func ExtractDeployment(deployment *appsv2alpha1.Deployment, fieldManager string) (*DeploymentApplyConfiguration, error) {
...
// Experimental!
func ExtractDeploymentStatus(deployment *appsv2alpha1.Deployment, fieldManager string) (*DeploymentApplyConfiguration, error) {
	return extractDeployment(deployment, fieldManager, "status")
}

func extractDeployment(deployment *appsv2alpha1.Deployment, fieldManager string, subresource string) (*DeploymentApplyConfiguration, error) {
	b := &DeploymentApplyConfiguration{}
	err := managedfields.ExtractInto(deployment, internal.Parser().Type("io.k8s.api.apps.v2alpha1.Deployment"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
