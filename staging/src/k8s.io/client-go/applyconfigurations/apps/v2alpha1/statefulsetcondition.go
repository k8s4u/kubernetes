...
type StatefulSetConditionApplyConfiguration struct {
	Type               *v2alpha1.StatefulSetConditionType `json:"type,omitempty"`
...
func (b *StatefulSetConditionApplyConfiguration) WithType(value v2alpha1.StatefulSetConditionType) *StatefulSetConditionApplyConfiguration {
	b.Type = &value
	return b
}
