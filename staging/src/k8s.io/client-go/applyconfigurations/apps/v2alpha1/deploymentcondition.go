...
type DeploymentConditionApplyConfiguration struct {
	Type               *v2alpha1.DeploymentConditionType `json:"type,omitempty"`
...
func (b *DeploymentConditionApplyConfiguration) WithType(value v2alpha1.DeploymentConditionType) *DeploymentConditionApplyConfiguration {
	b.Type = &value
	return b
}
