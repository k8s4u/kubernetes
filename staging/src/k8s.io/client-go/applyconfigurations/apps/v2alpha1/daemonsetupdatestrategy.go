...
type DaemonSetUpdateStrategyApplyConfiguration struct {
	Type          *v2alpha1.DaemonSetUpdateStrategyType     `json:"type,omitempty"`
...
func (b *DaemonSetUpdateStrategyApplyConfiguration) WithType(value v2alpha1.DaemonSetUpdateStrategyType) *DaemonSetUpdateStrategyApplyConfiguration {
	b.Type = &value
	return b
}
