...
// Experimental!
func ExtractStatefulSet(statefulSet *appsv2alpha1.StatefulSet, fieldManager string) (*StatefulSetApplyConfiguration, error) {
...
// Experimental!
func ExtractStatefulSetStatus(statefulSet *appsv2alpha1.StatefulSet, fieldManager string) (*StatefulSetApplyConfiguration, error) {
	return extractStatefulSet(statefulSet, fieldManager, "status")
}

func extractStatefulSet(statefulSet *appsv2alpha1.StatefulSet, fieldManager string, subresource string) (*StatefulSetApplyConfiguration, error) {
	b := &StatefulSetApplyConfiguration{}
	err := managedfields.ExtractInto(statefulSet, internal.Parser().Type("io.k8s.api.apps.v2alpha1.StatefulSet"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
