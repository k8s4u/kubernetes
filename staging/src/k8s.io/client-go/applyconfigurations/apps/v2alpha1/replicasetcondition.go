...
type ReplicaSetConditionApplyConfiguration struct {
	Type               *v2alpha1.ReplicaSetConditionType `json:"type,omitempty"`
...
func (b *ReplicaSetConditionApplyConfiguration) WithType(value v2alpha1.ReplicaSetConditionType) *ReplicaSetConditionApplyConfiguration {
	b.Type = &value
	return b
}
