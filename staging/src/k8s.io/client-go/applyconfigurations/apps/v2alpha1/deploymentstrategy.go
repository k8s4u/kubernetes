...
type DeploymentStrategyApplyConfiguration struct {
	Type          *v2alpha1.DeploymentStrategyType           `json:"type,omitempty"`
...
func (b *DeploymentStrategyApplyConfiguration) WithType(value v2alpha1.DeploymentStrategyType) *DeploymentStrategyApplyConfiguration {
	b.Type = &value
	return b
}
