...
type StatefulSetSpecApplyConfiguration struct {
	...
	PodManagementPolicy                  *v2alpha1.PodManagementPolicyType                                  `json:"podManagementPolicy,omitempty"`
...
func (b *StatefulSetSpecApplyConfiguration) WithPodManagementPolicy(value v2alpha1.PodManagementPolicyType) *StatefulSetSpecApplyConfiguration {
