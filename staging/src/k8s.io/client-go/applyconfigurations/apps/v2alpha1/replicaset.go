...
// Experimental!
func ExtractReplicaSet(replicaSet *appsv2alpha1.ReplicaSet, fieldManager string) (*ReplicaSetApplyConfiguration, error) {
...
// Experimental!
func ExtractReplicaSetStatus(replicaSet *appsv2alpha1.ReplicaSet, fieldManager string) (*ReplicaSetApplyConfiguration, error) {
	return extractReplicaSet(replicaSet, fieldManager, "status")
}

func extractReplicaSet(replicaSet *appsv2alpha1.ReplicaSet, fieldManager string, subresource string) (*ReplicaSetApplyConfiguration, error) {
	b := &ReplicaSetApplyConfiguration{}
	err := managedfields.ExtractInto(replicaSet, internal.Parser().Type("io.k8s.api.apps.v2alpha1.ReplicaSet"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
