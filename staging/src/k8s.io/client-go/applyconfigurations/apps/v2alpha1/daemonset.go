...
// Experimental!
func ExtractDaemonSet(daemonSet *appsv2alpha1.DaemonSet, fieldManager string) (*DaemonSetApplyConfiguration, error) {
...
// Experimental!
func ExtractDaemonSetStatus(daemonSet *appsv2alpha1.DaemonSet, fieldManager string) (*DaemonSetApplyConfiguration, error) {
	return extractDaemonSet(daemonSet, fieldManager, "status")
}

func extractDaemonSet(daemonSet *appsv2alpha1.DaemonSet, fieldManager string, subresource string) (*DaemonSetApplyConfiguration, error) {
	b := &DaemonSetApplyConfiguration{}
	err := managedfields.ExtractInto(daemonSet, internal.Parser().Type("io.k8s.api.apps.v2alpha1.DaemonSet"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
