...
type DaemonSetConditionApplyConfiguration struct {
	Type               *v2alpha1.DaemonSetConditionType `json:"type,omitempty"`
...
func (b *DaemonSetConditionApplyConfiguration) WithType(value v2alpha1.DaemonSetConditionType) *DaemonSetConditionApplyConfiguration {
	b.Type = &value
	return b
}
